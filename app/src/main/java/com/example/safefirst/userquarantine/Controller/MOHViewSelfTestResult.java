...
import com.example.safefirst.userquarantine.Model.SelfTestAdapter;
...
public class MOHViewSelfTestResult extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        db = new MainDB(MOHViewSelfTestResult.this);
        ...
        storeDataInArrays();
        selfTestAdapter = new SelfTestAdapter(MOHViewSelfTestResult.this, this, Test_ID, Test_Place, Test_Type, Test_Date, Test_Result, User_phoneNum);
    ...
    void confirmDialog() {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                MainDB db = new MainDB(MOHViewSelfTestResult.this);
